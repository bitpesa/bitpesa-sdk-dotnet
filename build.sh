...
${nuget_cmd} install src/TransferZero.Sdk/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TransferZero.Sdk.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TransferZero.Sdk.dll \
-recurse:'src/TransferZero.Sdk/*.cs' \
-doc:bin/TransferZero.Sdk.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TransferZero.Sdk.dll was created successfully"
fi
