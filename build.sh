...
${nuget_cmd} install src/BitPesa.Sdk/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/BitPesa.Sdk.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/BitPesa.Sdk.dll \
-recurse:'src/BitPesa.Sdk/*.cs' \
-doc:bin/BitPesa.Sdk.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/BitPesa.Sdk.dll was created successfully"
fi
