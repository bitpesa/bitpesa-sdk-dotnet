...
namespace TransferZero.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            ...
            if (status == 422) {
                return new ApiException(status,
                    string.Format("Validation error calling {0}", methodName),
                    response);
            } else if (status >= 400)
            {
                return new ApiException(status,
        ...
        {
            UserAgent = "TransferZero-SDK/.NET/1.0.0";
        ...
        /// <param name="apiSecret">Dictionary of API key prefix</param>
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "TransferZero-SDK/.NET/1.0.0"
        ...
        public virtual string ApiSecret
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException("ApiSecret may not be empty.");
                }
                _apiSecret = value;
            }
        }
        ...
        /// <summary>
        /// Gets or sets the API key based
        /// </summary>
        /// <value>The API key.</value>
        public virtual string ApiKey
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new InvalidOperationException("ApiKey may not be empty.");
                }
                _apiKey = value;
            }
        }
        ...
        /// </summary>
        /// <value>The string, parsed</value>
        public T ParseString<T>(string input) where T : class {
            return (T)JsonConvert.DeserializeObject(input, typeof(T), serializerSettings);
        }
        ...
        {
            String report = "C# SDK (TransferZero.Sdk) Debug Report:\n";
        ...
        public string GetSignature(string nonce, string url, string requestMethod, string input) {
			...
			string toSign = string.Format("{0}&{1}&{2}&{3}", nonce, requestMethod, url, shaHashOfBody);
			return GetHMACHash(toSign);
        }
		...
		private string GetHMACHash(string input)
		{
			HMACSHA512 hmacDigest = new HMACSHA512(Encoding.UTF8.GetBytes(ApiSecret));
			// Convert the input string to a byte array and compute the hash.
