...
namespace TransferZero.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecipientWebhook :  IEquatable<RecipientWebhook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientWebhook" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RecipientWebhook() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientWebhook" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RecipientWebhook);
        }

        /// <summary>
        /// Returns true if RecipientWebhook instances are equal
        /// </summary>
        /// <param name="input">Instance of RecipientWebhook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientWebhook input)
        {
            if (input == null)
                return false;
