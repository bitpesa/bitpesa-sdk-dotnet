...
namespace TransferZero.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SenderWebhook :  IEquatable<SenderWebhook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SenderWebhook" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SenderWebhook() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SenderWebhook" /> class.
        /// </summary>
        /// <param name="_object">_object (required).</param>
        public SenderWebhook(Sender _object = default(Sender))
        {
            this.Object = _object;
        }
        ...
        {
            return this.Equals(input as SenderWebhook);
        }

        /// <summary>
        /// Returns true if SenderWebhook instances are equal
        /// </summary>
        /// <param name="input">Instance of SenderWebhook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SenderWebhook input)
        {
            if (input == null)
                return false;
